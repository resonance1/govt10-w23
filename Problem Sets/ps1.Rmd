...
_Option 2:_ (for those not using git)

Download "turnout.csv" to your current directory, then load it
```{r}
download.file("https://raw.githubusercontent.com/resonance1/govt10-w23/72bdf5dc32c9b66921988ab1b5ccd188bff06278/Problem%20Sets/turnout.csv","./turnout.csv")
turnout <- read.csv('turnout.csv')
```
