...
A)  Sync git, or download the .zip file and place all contents within your current working directory. Then, read in the file:
...
Using the new variable, calculate the average size of the freshman class within the dataset.
...
Then, in the console (bottom left window), type: swirl() Follow the prompts, and select the course 'qss-swirl'. Then choose Selection 1 (Intro 1). Continue until you get to \~80% completion. Note that the results will not be saved in the notebook - this is just an opportunity to practice. 
