...
# Plan
* Observational Designs (Lecture)
* DiD practice

# Review: Distributions and Contextualizing Effect Sizes
...
#ggplot(chechen,aes(diffattack,colour=fire,group=fire)) + geom_density(adjust=2)
...
Let's create three new variables measuring the proportion of full time employees, before and after the change in wages. 

```{r}

```

Let's create two filtered data frames, one for NJ and one for PA
...
Difference in Differences Step 1: We need the longitudinal average difference of the outcome, for NJ and PA.
