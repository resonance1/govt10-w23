...
You will submit all assignments and problem sets as PDFs. You create a PDF you will click the down arrow to the right of the *Knit* button and select *Knit to PDF*. To create a PDF, you must first install tinytex. Run the code chunk below:

```{r}
install.packages('tinytex')
tinytex::install_tinytex()
```
Now try to Knit to PDF. If it doesn't work, let me know via Slack and I will help you trouble shoot. For now, you can submit either your .rmd file or your .pdf file to complete the class notebook.
